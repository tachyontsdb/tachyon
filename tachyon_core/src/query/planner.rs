    ...
    fn handle_binary_expr(
        ...
        Ok(TNode::BinaryOp(BinaryOpNode::new(
            match expr.op.id() {
                ...
                parser::token::T_EQLC => BinaryOp::Equal,
                parser::token::T_NEQ => BinaryOp::NotEqual,
                parser::token::T_GTR => BinaryOp::Greater,
                parser::token::T_LSS => BinaryOp::Less,
                parser::token::T_GTE => BinaryOp::GreaterEqual,
                parser::token::T_LTE => BinaryOp::LessEqual,
